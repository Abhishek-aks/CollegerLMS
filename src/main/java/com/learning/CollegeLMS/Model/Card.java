...
public class Card {
    ...
    //plan is to save this card in database
    //before saving I have  to set its attributes: Rule 1

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private int id; //its Autogenerated

    @CreationTimestamp //Auto timestamp the time when an entry is created
    private Date createdOn; //its Autogenerated

    @UpdateTimestamp //Sets time when an entry is updated.
    private Date updatedOn; //its Autogenerated

    @Enumerated(value=EnumType.STRING)
    private CardStatus cardStatus; // set this attributes
